    ...
    public class LolMonitor
    {
        ...
        public static void reportMainModule()
        {
            try
            {
                ...
                if (processes != null && processes.Length > 0)
                {
                    ...
                    {
                        lolPath = string.Concat(p.MainModule.FileName.Replace("cross\\crossproxy.exe", "Air\\LolClient.exe"));
                        ...
                        HttpClient.post(REPORT_LOLCLIENTPATH, lolPath.Replace("LolClient.exe", ""));
                    }
                }
            }
            catch (Exception e)
        ...
        static void findCurPlayerAndReportStatus(string status, int lolClientId)
        {
            try
            {
                ...
                Thread.Sleep(30000);
                LolPlayer player = GMDataTask.getPlayerInfoById(lolClientId);
