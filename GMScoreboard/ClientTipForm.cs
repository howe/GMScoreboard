...
{
    public partial class ClientTipForm : Form
    {
        private ClientTip tip;
        public ClientTipForm(ClientTip tip)
        {
            InitializeComponent();

            this.tip = tip;
            this.headText.Text = tip.headText;
            this.linkText.Text = tip.linkText;
            this.title.Text = tip.title;
            this.content.Text = "    " + tip.content;
        }
        ...
        private void ClientTipForm_Load(object sender, EventArgs e)
        {
